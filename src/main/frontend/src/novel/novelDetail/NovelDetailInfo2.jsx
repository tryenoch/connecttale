            ...
            <div className={'my-1'}>
              ...
              <p className={'fw-bold'}>{baseItem.novelPubli}<span className={'ms-2 text-muted'}>출판</span></p>
              {
                baseItem.ebookCheck == '웹소설'
                  ...
                  : <p className={'fw-bold'}>총 {baseItem.novelCount} 권 / {baseItem.novelCompleteYn == 'Y' ? '완결' : baseItem.novelUpdateDate ? `연재중 | ${baseItem.novelUpdateDate}` : '연재중'}</p>
              }
              {
                ...
                <table className={'table table-hover detail-price-table'}>
                      {
                        Object.keys(kakao).length != 0
                            ?
                            <tr>
                              <Link to={`https://page.kakao.com/content/${kakao.platformId}`}>
                              <td>
                      ...
                      }
                      {
                        Object.keys(naver).length != 0
                            ? <tr>
                              ...
                              <td><p><img src="/naver-series-icon.png" alt="" className={'platform-logo me-2'}/>네이버시리즈 <span
                      ...
                      }
                      {
                        Object.keys(ridi).length != 0
                            ? <tr>
                              <Link to={`https://ridibooks.com/books/${ridi.platformId}`}>
