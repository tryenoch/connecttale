          ...
          <Col xs={10} className={'my-5 mx-auto'}>
            <Row className={'py-2 mb-3'}>
              <div className={'text-center mb-3'}>
                <h1 className={'fw-bold board-title lg'}>{boardList[query.id].title}</h1>
              </div>
            </Row>
            <form onSubmit={handleSubmit}>
              <Row className={'mb-3 board-write-header py-1'}>
                {
                    (boardCate == 1) &&
                    (<Col xs={2} className={"seperate"}>
                      <div>
                        <Form.Select
                            className={'select-cate cursor fw-bold'}
                            value={reqCate}
              ...
              <div className={'d-flex justify-content-between'}>
                <button type={'button'} className={'btn btn-secondary me-2 px-4'} onClick={handleMoveToMenu}>목록
                </button>
                <button type={'submit'} className={'btn btn-purple px-4'}>작성</button>
              </div>
            </form>
          </Col>
        </Row>
