                ...
                <div className={'row mt-3'}>
                    <div className={'col-sm-10 ms-4 ms-auto'}>
                        ...
                        <div className={'row mt-4'}>
                            ...
                            <div className={'col-sm-9 d-flex'}>
                                <input type="password" name={'pw'} id={'pw'} className={'input-s5 form-control rounded-1'} placeholder={'비밀번호를 입력하세요'} onChange={changePw}/>
                            </div>
                        </div>
                        <div className={'row mt-4'}>
                            <div className={'col-sm-3'}>
                        ...
                        <div className={'row mt-4'}>
                            ...
                            <div className={'col-sm-9 d-flex'}>
                                <input type="text" name={'name'} id={'name'} className={'input-s5 form-control rounded-1'} placeholder={'이름을 입력하세요'} onChange={changeName}/>
                            </div>
                        </div>
                        <div className={'row mt-4'}>
                            <div className={'col-sm-3'}>
                            ...
                            <div className={'col-sm-9 d-flex'}>
                                <input type="text" name={'nick'} id={'nick'} className={'input-s5 form-control rounded-1'} placeholder={'닉네임을 입력하세요'} onChange={changeNick}/>
                            </div>
                        </div>
                        <div className={'row mt-4'}>
                            <div className={'col-sm-3'}>
                        ...
                        <div className={'row mt-4'}>
                            ...
                            <div className={'col-sm-9 d-flex'}>
                                <input type="radio" name={'gender'} id={'male'} value={1} onSelect={changeGender}/>
                                <label htmlFor="male" className={'ms-1 mt-2 me-5'}>남성</label>
                                <input type="radio" name={'gender'} id={'female'} value={2} onSelect={changeGender}/>
